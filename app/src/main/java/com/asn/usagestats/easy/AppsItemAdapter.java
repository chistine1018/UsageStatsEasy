...
public class AppsItemAdapter extends ArrayAdapter<AppItem> {
    public AppsItemAdapter(Context context, ArrayList<AppItem> usageStatDTOArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        AppItem usageStats = getItem(position);
